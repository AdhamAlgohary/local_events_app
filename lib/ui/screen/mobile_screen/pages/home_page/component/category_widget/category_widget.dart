...
import 'package:local_events_app/ui/screen/mobile_screen/pages/home_page/home_page_functions/select_category_on_tap_func.dart';
      ...
      children: [
        Padding(
          padding: EdgeInsets.only(
              left: 0.03 * width, top: 0.03 * height, right: 0.03 * width),
          child: const Row(
            children: <Widget>[
              Text(
                'LOCAL EVENTS',
            ...
            builder: (_, categories, __) => ListView.builder(
                ...
                itemBuilder: (_, index) {
                  ...
                  return Container(
                    ...
                    padding: EdgeInsets.symmetric(
                        horizontal: 0.05 * width, vertical: 0.002 * width),
                    width: 0.3 * width,
